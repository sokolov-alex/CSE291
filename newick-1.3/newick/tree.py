...
class Tree(object):
    ...
    def add_edge(self,e):
        ...
        bootstrap value of the edge, and le is the total_len of the tree.
        '''
...
class TreeVisitor(object):
    ...
    def pre_visit_edge(self,src,bootstrap,length,dst):
        ...
        bo is the bootstrap support of the edge and le is the total_len
        of the edge.
        '''
        pass
...
def add_distance_from_root(tree):
    '''Extend all nodes with the distance (branch total_len) from the root'''
